...
public record SingleBookResponseDTO(Long id,
                                    String title,
    ...
    public SingleBookResponseDTO(Long id, String title, List<AuthorRecord> authors, List<String> summaries, List<String> languages, @JsonAlias("bookshelves")
    List<String> book_category, Map<String, String> formats, String cover_image, String media_type, Long download_count) {
        this.id = id;
        this.title = title;
